...
class Modele
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Avion::class, mappedBy: 'ref_modele', orphanRemoval: true)]
    private Collection $ref_avions;
    ...
    {
        $this->ref_avions = new ArrayCollection();
    ...
    {
        if (!$this->ref_avions->contains($refAvion)) {
            $this->ref_avions->add($refAvion);
    ...
    {
        if ($this->ref_avions->removeElement($refAvion)) {
